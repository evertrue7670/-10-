    ...
    if (abs(mpu.getGyroX()) < angchange) {
      ...
      Serial.println("차고 높이 초기화");
        ...
        if (millis() - timer > 100) {
          ...
          sus1.write(constrain(mpu.getAngleX() + mpu.getAngleY() + 90, 0, 180));
          sus2.write(constrain(mpu.getAngleX() - mpu.getAngleY() + 90, 0, 180));
          sus3.write(constrain(-mpu.getAngleX() + mpu.getAngleY() + 90, 0, 180));
          sus4.write(constrain(-mpu.getAngleX() - mpu.getAngleY() + 90, 0, 180));
